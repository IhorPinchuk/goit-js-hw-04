...
// const uniqueGenres = allGenres.filter((genre, index, allGenres) => index === allGenres.indexOf(genre));
...
//   return usersFriends.filter((friend, index, usersFriends) => index === usersFriends.indexOf(friend));
// };
// // Change code above this line
...
// console.log(getUserWithEmail(users, 'sfdf@furnigeer.com'));
...
//   return player.playtime / player.gamesPlayed + averageTime;
// }, 0);
...
//  return users.reduce((sumBalance, user) => {
